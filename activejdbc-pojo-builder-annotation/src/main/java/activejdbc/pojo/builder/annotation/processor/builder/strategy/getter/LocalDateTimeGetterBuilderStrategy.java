...
public class LocalDateTimeGetterBuilderStrategy implements GetterBuilderStrategy{
     ...
     * 4. column name
     */
    private static final String LOCAL_DATE_TIME_GETTER_TEMPLATE = "public %s %s() {%n" +
    ...
    public String buildGetterBody(String type, String columnName, String activejdbcObjectName) {
        ...
        return String.format(LOCAL_DATE_TIME_GETTER_TEMPLATE, type, methodName, activejdbcObjectName, columnName);
    }
}
