...
import activejdbc.wrapper.annotation.processor.adapter.builder.strategy.getter.LongGetterBuilderStrategy;
...
public class LongGetterBuilderStrategyTest {
    ...
    public void should_generate_getter(String desiredFieldName, String expectedMethod) {
        ...
        String expectedGetter = String.format("public Long %s() {%n" +
