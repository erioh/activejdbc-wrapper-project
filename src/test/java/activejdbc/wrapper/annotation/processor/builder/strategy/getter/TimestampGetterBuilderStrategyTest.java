...
import activejdbc.wrapper.annotation.processor.adapter.builder.strategy.getter.TimestampGetterBuilderStrategy;
...
public class TimestampGetterBuilderStrategyTest {
    ...
    public void should_generate_getter(String desiredFieldName, String expectedMethod) {
        ...
        String expectedGetter = String.format("public Timestamp %s() {%n" +
