...
import activejdbc.wrapper.annotation.processor.wrapper.builder.strategy.getter.LocalDateTimeGetterBuilderStrategy;
...
public class LocalDateTimeGetterBuilderStrategyTest {
    ...
    public void should_generate_getter(String desiredFieldName, String expectedMethod) {
        ...
        String expectedGetter = String.format("public LocalDateTime %s() {%n" +
