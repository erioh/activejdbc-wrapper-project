...
import activejdbc.wrapper.annotation.processor.wrapper.builder.strategy.getter.IntegerGetterBuilderStrategy;
...
public class IntegerGetterBuilderStrategyTest {
    ...
    public void should_generate_getter(String desiredFieldName, String expectedMethod) {
        ...
        String expectedGetter = String.format("public Integer %s() {%n" +
