...
import activejdbc.wrapper.annotation.processor.adapter.builder.strategy.setter.TimestampSetterBuilderStrategy;
...
public class TimestampSetterBuilderStrategyTest {
    ...
    public void should_generate_setter(String desiredFieldName, String methodName, String expectedColumnName) {
        ...
        String expectedGetter = String.format("public void %s(Timestamp %s) {%n" +
                "object.setTimestamp(\"COLUMN_NAME\", %s);%n" +
