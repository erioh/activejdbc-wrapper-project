...
import activejdbc.wrapper.annotation.processor.wrapper.builder.strategy.getter.ShortGetterBuilderStrategy;
...
public class ShortGetterBuilderStrategyTest {
    ...
    public void should_generate_getter(String desiredFieldName, String expectedMethod) {
        ...
        String expectedGetter = String.format("public Short %s() {%n" +
