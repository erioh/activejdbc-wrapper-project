...
import activejdbc.wrapper.annotation.processor.wrapper.builder.strategy.getter.LocalTimeGetterBuilderStrategy;
...
public class LocalTimeGetterBuilderStrategyTest {
    ...
    public void should_generate_getter(String desiredFieldName, String expectedMethod) {
        ...
        String expectedGetter = String.format("public LocalTime %s() {%n" +
