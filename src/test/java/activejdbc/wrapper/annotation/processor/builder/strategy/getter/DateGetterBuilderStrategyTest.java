...
import activejdbc.wrapper.annotation.processor.adapter.builder.strategy.getter.DateGetterBuilderStrategy;
...
public class DateGetterBuilderStrategyTest {
    ...
    public void should_generate_getter(String desiredFieldName, String expectedMethod) {
        ...
        String expectedGetter = String.format("public Date %s() {%n" +
