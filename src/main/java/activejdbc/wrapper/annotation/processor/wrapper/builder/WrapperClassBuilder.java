...
package activejdbc.wrapper.annotation.processor.wrapper.builder;
...
import activejdbc.wrapper.annotation.processor.wrapper.builder.strategy.WrapperBuilderClassBuilder;
...
public class WrapperClassBuilder {
    ...
    public static final String CLASS_TEMPLATE = "package %s;%n" +
            "import %s.%s;%n" +
            "public class %s extends activejdbc.wrapper.annotation.processor.wrapper.builder.ActivejdbcWrapper<%s>{%n" +
            "private %s %s;%n" +
            "%s%n" +
            "%s%n" +
            "%s%n" +
